...
base_exclude <- c("HB0828", "HB0863", "PL0066", "PL0108", "PL0203", 
                  "PL0258", "PL0027", "PL0053", "30.ESP_1983b", "PL0026")
...
# ✅ Plot
pdf("modern57_stacked_PropNorm_byBestHTF.pdf", width = 11, height = 5)
ggplot(df_all, aes(x = IsolateLabel, y = PropNorm, fill = Reference)) +
  ...
  labs(title = "Normalized K-mer Proportions Ordered by Best HTF Match (Modern 57)",
...
write.table(
  df_all %>% select(Isolate, Reference, Total_Allele_Kmers, Matched_Kmers, PropNorm),
  "newsummarymodern57_tailocin_kmer_propnorm.tsv",
  sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE
)

cat("✅ Done:\n- modern57_stacked_PropNorm_byBestHTF.pdf\n- m57sample_bestHTF.txt\n- newsummarymodern57_tailocin_kmer_propnorm.tsv\n")
