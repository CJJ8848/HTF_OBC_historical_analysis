setwd('/Users/cuijiajun/Desktop/2023-2024\ PhD\ ucl/2024_aMeta/wholepipeAt_Ps/2024_233_analysis/mapdamage/mapdamage2024_29/tops/')
args <- commandArgs(trailingOnly = TRUE)
print(args)
tablePs<-read.table(paste('/Users/cuijiajun/Desktop/2023-2024\ PhD\ ucl/2024_aMeta/wholepipeAt_Ps/2024_233_analysis/mapdamage/mapdamage2024_29/tops/',args[1],'/misincorporation.txt',sep=''),header = T)
#tablePs<-read.table('/Users/cuijiajun/Desktop/2023-2024\ PhD\ ucl/2024_aMeta/wholepipeAt_Ps/mapdamage/mapdamage2024_22/tops/results/PL0027.mapped_to_Pseudomonas.dd.q20.mapDamage/misincorporation.txt',header = TRUE)

samplename=args[2]
#samplename='PL0027.mapped_to_Pseudomonas.dd.q20.mapDamage'
#tableAt<-read.table('/Users/cuijiajun/Desktop/others/tmphernan/mapdamage/usedforCFML_ps/results_HB0841.sort/misincorporation.txt',header = T)
subtable<-tablePs[which(tablePs$End=='5p'),3:22]
